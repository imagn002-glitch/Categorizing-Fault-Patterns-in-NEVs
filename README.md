...
- **Features**: Sensor Measurements: battery voltage (V), battery current (A), engine temperature (°C), motor efficiency (%), tire pressure (PSI), fuel efficiency (MPG), speed (km/h), acceleration (m/s²), driving distance (km), ambient temperature (°C), and humidity (%).
